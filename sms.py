...
:......:::..:::::..:::......:::::::......:::..:::::::::..:::::..::..:::::..::..:::::..::........::..:::::..::
      ...
      \033[1;30m================ SMS SPAMMER =================\033[1;37m

                        By Tomaya Season
                        ================         

""")
numbers = input("\033[1;30mเบอร์โทรศัพท์\033[1;37m:\033[0;32m ")
num = int(input("\033[1;30mจำนวนที่จะยิง \033[1;37m:\033[0;32m "))
class SMS():
...
def loop(num):
    for i in range(1,num+1):
        t.spamais(numbers)
        print("\033[1;30mกำลังยิง\033[1;37m :\033[0;32m %i" % i)
loop(num)
